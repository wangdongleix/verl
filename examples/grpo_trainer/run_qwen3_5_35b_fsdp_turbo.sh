...
MINDSPEED_CONFIG=(
    ...
    actor_rollout_ref.actor.mindspeed.fsdp_kwargs.distributed.fully_shard_parallel_size=${fsdp_size}
    actor_rollout_ref.actor.mindspeed.fsdp_kwargs.distributed.expert_parallel_size=${EP_SIZE}
    actor_rollout_ref.actor.mindspeed.fsdp_kwargs.distributed.expert_parallel_size=${SP_SIZE}
    ...
    actor_rollout_ref.actor.mindspeed.use_torch_compile=False
    actor_rollout_ref.ref.mindspeed.use_torch_compile=False
